...
mpirun -np 8 dissect.mpich  --gwas --bfile-grm-list HD/GWAS_GRM${i}.txt --pheno LambWeightPhenotypes.txt --pheno-col 1 --covar LambWeightAssoc.txt --qcovar LambWeightQAssoc.txt --random-effects LambWeightRandom.txt --random-effects-cols 1 2 --out HD/LambWeight_HD_GWAS_Chr${i}  

if [[ -f HD/LambWeight_HD_GWAS_Chr${i}.badsnps ]]  
then  
plink --bfile HD/Chr${i} --sheep --chr ${i} --exclude HD/LambWeight_HD_GWAS_Chr${i}.badsnps --make-bed --out HD/Chr${i}_2  
