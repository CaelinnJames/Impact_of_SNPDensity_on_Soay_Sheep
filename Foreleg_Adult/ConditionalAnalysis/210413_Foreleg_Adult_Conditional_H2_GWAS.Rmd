---
title: "Adult Foreleg Length - Heritability estimate and GWAS Conditional Analysis"
...
>q()  
>  
>plink \-\-bfile 50K/AdultForeLeg50K \-\-sheep \-\-not-chr 0,X \-\-exclude-snps SNPs_50K.txt \-\-make-bed \-\-out 50K/Conditional_50K_Geno  
>plink \-\-bfile HD/AdultForeLegHD \-\-sheep \-\-not-chr X \-\-exclude-snps SNPs_HD.txt \-\-make-bed \-\-out HD/Conditional_HD_Geno  
>  
>plink \-\-bfile 50K/AdultForeLeg50K \-\-sheep \-\-snps SNPs_50K.txt \-\-keep AdultForeLegPhenotypes.txt \-\-recodeA \-\-out AdultMetaSNP 
...
>  
>plink \-\-bfile HD/AdultForeLegHD \-\-sheep \-\-snps SNPs_HD.txt \-\-keep AdultForeLegPhenotypes.txt \-\-recodeA \-\-out AdultMetaSNP 
>cut -d ' ' -f 3-6 \-\-complement AdultMetaSNP.raw > AdultMetaSNP.txt  
>sed '1d' AdultMetaSNP.txt > AdultMetaSNP2.txt 
>  
>sort -k 2,2 AdultForeLegQAssoc.txt > Assoc1.txt  
...
>module load igmm/apps/plink/1.90b4  
>  
>mpirun -np 8 dissect.mpich  \-\-reml \-\-bfile 50K/Conditional_50K_Geno  \-\-pheno AdultForelegPhenotypes.txt \-\-pheno-col 2 \-\-blue \-\-covar Assoc_50K.txt \-\-qcovar QAssoc_50K.txt \-\-random-effects ForelegRandom.txt \-\-random-effects-cols 1 2 3 \-\-out 50K/AdultForeLeg_50K_Conditional_H2  
>  
...
>
>mpirun -np 8 dissect.mpich  \-\-reml \-\-bfile 50K/AdultForeLeg_50K_Conditional_H2 \-\-pheno AdultForelegPhenotypes.txt \-\-pheno-col 2 \-\-blue \-\-covar Assoc_50K.txt \-\-qcovar QAssoc_50K.txt \-\-random-effects ForelegRandom.txt \-\-random-effects-cols 1 2 3 \-\-out 50K/AdultForeLeg_50K_Conditional_H2  
>fi 


```{r,include=FALSE}
Assoc <- read.table("C:/Users/s1944058/Documents/Sheep/R/H2_GWAS/Foreleg/Adult/50K/AdultForeLeg_50K_Conditional_H2.blue.discrete",header=TRUE)
Assoc$NAME <- c("Sex")
SNPs_50K <- read.table("C:/Users/s1944058/Documents/Sheep/R/H2_GWAS/Foreleg/Adult/50K/SNPs_50K.txt",header=F)
...
QAssoc <- read.table("C:/Users/s1944058/Documents/Sheep/R/H2_GWAS/Foreleg/Adult/50K/AdultForeLeg_50K_Conditional_H2.blue.quantitative",header=TRUE)
QAssoc$NAME <- c("Population","Age at death",SNPs_50K[,3])
FixedEffects_50K <- rbind(Assoc,QAssoc)

Random <- read.csv("C:/Users/s1944058/Documents/Sheep/R/H2_GWAS/Foreleg/Adult/50K/AdultForeLeg_50K_Conditional_H2.reml")
...
>module load igmm/apps/plink/1.90b4  
>  
>mpirun -np 8 dissect.mpich  \-\-reml \-\-bfile HD/Conditional_HD_Geno \-\-pheno AdultForelegPhenotypes.txt \-\-pheno-col 2 \-\-blue \-\-covar Assoc_HD.txt \-\-qcovar QAssoc_HD.txt \-\-random-effects ForelegRandom.txt \-\-random-effects-cols 1 2 3 \-\-out HD/AdultForeLeg_HD_Conditional_H2  
>  
...
>
>mpirun -np 8 dissect.mpich  \-\-reml \-\-bfile HD/AdultForeLeg_HD_Conditional_H2 \-\-pheno AdultForelegPhenotypes.txt \-\-pheno-col 2 \-\-blue \-\-covar Assoc_HD.txt \-\-qcovar QAssoc_HD.txt \-\-random-effects ForelegRandom.txt \-\-random-effects-cols 1 2 3 \-\-out HD/AdultForeLeg_HD_Conditional_H2  
>fi 
 

```{r,include=FALSE}
Assoc <- read.table("C:/Users/s1944058/Documents/Sheep/R/H2_GWAS/Foreleg/Adult/HD/AdultForeLeg_HD_Conditional_H2.blue.discrete",header=TRUE)
Assoc$NAME <- c("Sex")
SNPs_HD <- read.table("C:/Users/s1944058/Documents/Sheep/R/H2_GWAS/Foreleg/Adult/HD/SNPs_HD.txt",header=FALSE)
...
QAssoc <- read.table("C:/Users/s1944058/Documents/Sheep/R/H2_GWAS/Foreleg/Adult/HD/AdultForeLeg_HD_Conditional_H2.blue.quantitative",header=TRUE)
QAssoc$NAME <- c("Population","Age at death",SNPs_HD[,3])
FixedEffects_HD <- rbind(Assoc,QAssoc)

Random <- read.csv("C:/Users/s1944058/Documents/Sheep/R/H2_GWAS/Foreleg/Adult/HD/AdultForeLeg_HD_Conditional_H2.reml")
...
>i=\$\SGE_TASK_ID  
>  
>plink \-\-bfile 50K/Conditional_50K_Geno \-\-sheep \-\-not-chr \$\{i},X \-\-keep AdultForelegPhenotypes.txt \-\-make-bed \-\-out 50K/NoChr\$\{i}  
>  
...
>  
>plink \-\-bfile 50K/Conditional_50K_Geno \-\-sheep \-\-chr \$\{i} \-\-keep AdultForelegPhenotypes.txt \-\-make-bed \-\-out 50K/Chr\$\{i}  
>  
...
>fi  
>  
>mpirun -np 8 dissect.mpich  \-\-gwas \-\-bfile-grm-list 50K/GWAS_GRM\$\{i}.txt \-\-pheno AdultForelegPhenotypes.txt \-\-pheno-col 2 \-\-covar Assoc_50K.txt \-\-qcovar QAssoc_50K.txt \-\-random-effects ForelegRandom.txt \-\-random-effects-cols 1 2 3  \-\-out 50K/AdultForeLeg_50K_GWAS_Conditional_Chr\$\{i}  
>  
>if [[ -f 50K/AdultForeLeg_50K_GWAS_Conditional_Chr\$\{i}.badsnps ]]  
>then  
>plink \-\-bfile 50K/Chr\$\{i} \-\-sheep \-\-exclude 50K/AdultForeLeg_50K_GWAS_Conditional_Chr\$\{i}.badsnps \-\-make-bed \-\-out 50K/Chr\$\{i}_2  
>  
...
```{r,fig.width=14}
files = list.files(pattern="AdultForeLeg_50K_GWAS_Conditional_Chr",recursive=TRUE)
...
>i=\$\SGE_TASK_ID  
>  
>plink \-\-bfile HD/Conditional_HD_Geno \-\-sheep \-\-not-chr \$\{i},X \-\-keep AdultForelegPhenotypes.txt \-\-make-bed \-\-out HD/NoChr\$\{i}  
>  
>mpirun -np 8 dissect.mpich  \-\-make-grm \-\-bfile HD/NoChr\$\{i} \-\-out HD/NoChr\$\{i}_GRM  
>  
>echo "HD/Chr\$\{i} HD/NoChr\$\{i}_GRM" > HD/GWAS_GRM\$\{i}.txt  
>  
>plink \-\-bfile HD/Conditional_HD_Geno \-\-sheep \-\-chr \$\{i} \-\-keep AdultForelegPhenotypes.txt \-\-make-bed \-\-out HD/Chr\$\{i}  
>  
...
>fi  
>  
>mpirun -np 8 dissect.mpich  \-\-gwas \-\-bfile-grm-list HD/GWAS_GRM\$\{i}.txt \-\-pheno AdultForelegPhenotypes.txt \-\-pheno-col 2 \-\-covar Assoc_HD.txt \-\-qcovar QAssoc_HD.txt \-\-random-effects ForelegRandom.txt \-\-random-effects-cols 1 2 3  \-\-out HD/AdultForeLeg_HD_GWAS_Conditional_Chr\$\{i}  
>  
>if [[ -f HD/AdultForeLeg_HD_GWAS_Conditional_Chr\$\{i}.badsnps ]]  
>then  
>plink \-\-bfile HD/Chr\$\{i} \-\-sheep \-\-exclude HD/AdultForeLeg_HD_GWAS_Conditional_Chr\$\{i}.badsnps \-\-make-bed \-\-out HD/Chr\$\{i}_2  
>
...
```{r,fig.width=14}
files = list.files(pattern="AdultForeLeg_HD_GWAS_Conditional_Chr",recursive=TRUE)
...
png(file="C:/Users/s1944058/Documents/Sheep/R/H2_GWAS/Foreleg/Adult_Foreleg_GWAS_Conditional.png",width=827,height=583)
...
mtext(text = "Conditional Analysis, imputed SNP data",
      side = 1,
      line = 0)
mtext("Adult foreleg length conditional GWAS analysis",outer=TRUE,cex=1.5)
