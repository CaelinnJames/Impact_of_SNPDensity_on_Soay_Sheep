...
mpirun -np 8 dissect.mpich  --gwas --bfile-grm-list HD/GWAS_GRM${i}.txt --pheno LambForeLegPhenotypes.txt --pheno-col 1 --covar LambForeLegAssoc.txt --qcovar LambForeLegQAssoc.txt --random-effects LambForeLegRandom.txt --random-effects-cols 1 2 --out HD/LambForeLeg_HD_GWAS_Chr${i}  

if [[ -f HD/LambForeLeg_HD_GWAS_Chr${i}.badsnps ]]  
then  
plink --bfile HD/Chr${i} --sheep --chr ${i} --exclude HD/LambForeLeg_HD_GWAS_Chr${i}.badsnps --make-bed --out HD/Chr${i}_2  
