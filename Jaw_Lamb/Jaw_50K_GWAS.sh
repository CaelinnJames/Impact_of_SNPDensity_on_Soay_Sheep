...
plink --bfile ../../InputData/Plates_1to87_QC3 --sheep --not-chr ${i},X --keep JawLength_LambPhenotypes.txt --make-bed --out 50K/NoChr${i}  
  
dissect.mpich  --make-grm --bfile 50K/NoChr${i} --out 50K/NoChr${i}_GRM  
  
echo "50K/Chr${i} 50K/NoChr${i}_GRM" > 50K/GWAS_GRM${i}.txt  
  
plink --bfile ../../InputData/Plates_1to87_QC3 --sheep --chr ${i} --keep JawLength_LambPhenotypes.txt --make-bed --out 50K/Chr${i}  
...
dissect.mpich  --gwas --bfile-grm-list 50K/GWAS_GRM${i}.txt --pheno JawLength_LambPhenotypes.txt --covar JawLength_LambAssoc.txt --random-effects JawLength_LambRandom.txt --random-effects-cols 1 2  --out 50K/JawLength_Lamb_50K_GWAS_Chr${i}  
