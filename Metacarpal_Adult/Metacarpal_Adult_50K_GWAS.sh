...
plink --bfile ../InputData/Plates_1to87_QC3 --sheep --not-chr ${i},X --keep MetacarpalLength_AdultPhenotypes.txt --make-bed --out 50K/NoChr${i}  
  
dissect.mpich  --make-grm --bfile 50K/NoChr${i} --out 50K/NoChr${i}_GRM  
  
echo "50K/Chr${i} 50K/NoChr${i}_GRM" > 50K/GWAS_GRM${i}.txt  
  
plink --bfile ../InputData/Plates_1to87_QC3 --sheep --chr ${i} --keep MetacarpalLength_AdultPhenotypes.txt --make-bed --out 50K/Chr${i}  
...
dissect.mpich  --gwas --bfile-grm-list 50K/GWAS_GRM${i}.txt --pheno MetacarpalLength_AdultPhenotypes.txt --covar MetacarpalLength_AdultAssoc.txt --qcovar MetacarpalLength_AdultQAssoc.txt --random-effects MetacarpalLength_AdultRandom.txt --random-effects-cols 1  --out 50K/MetacarpalLength_Adult_50K_GWAS_Chr${i}  
