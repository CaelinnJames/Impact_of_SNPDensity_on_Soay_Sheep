---
title: "Adult Metacarpal Length - Heritability estimate and GWAS Conditional Analysis"
...
>  
>plink \-\-bfile ../InputData/Plates_1to87_QC3 \-\-sheep \-\-snps SNPs_50K.txt \-\-keep MetacarpalLength_AdultPhenotypes.txt \-\-recodeA \-\-out AdultMetaSNP 
...
>  
>plink \-\-bfile ../InputData/HD_QC \-\-sheep \-\-snps SNPs_HD.txt \-\-keep MetacarpalLength_AdultPhenotypes.txt \-\-recodeA \-\-out AdultMetaSNP 
>cut -d ' ' -f 3-6 \-\-complement AdultMetaSNP.raw > AdultMetaSNP.txt  
>sed '1d' AdultMetaSNP.txt > AdultMetaSNP2.txt 
>  
>sort -k 2,2 MetacarpalLength_AdultQAssoc.txt > Assoc1.txt  
...
>module load igmm/apps/plink/1.90b4  
>  
>mpirun -np 8 dissect.mpich  \-\-reml \-\-bfile ../InputData/Plates_1to87_QC3  \-\-pheno MetacarpalPhenotypes.txt \-\-pheno-col 1 \-\-blue \-\-covar Assoc.txt \-\-qcovar QAssoc.txt \-\-random-effects MetacarpalRandom.txt \-\-random-effects-cols 1 2 \-\-out 50K/MetacarpalLength_Adult_50K_Conditional_H2  
>  
>if [[ -f 50K/MetacarpalLength_Adult_50K_Conditional_H2.badsnps ]]  
>then    
>plink \-\-bfile ../InputData/Plates_1to87_QC3 \-\-sheep \-\-exclude 50K/MetacarpalLength_Adult_50K_Conditional_H2.badsnps \-\-make-bed \-\-out 50K/MetacarpalLength_Adult_50K_Conditional_H2  
>
>mpirun -np 8 dissect.mpich  \-\-reml \-\-bfile 50K/MetacarpalLength_Adult_50K_Conditional_H2 \-\-pheno MetacarpalPhenotypes.txt \-\-pheno-col 1 \-\-blue \-\-covar Assoc.txt \-\-qcovar QAssoc.txt \-\-random-effects MetacarpalRandom.txt \-\-random-effects-cols 1 2 \-\-out 50K/MetacarpalLength_Adult_50K_Conditional_H2  
>fi 


```{r,include=FALSE}
Assoc <- read.table("C:/Users/s1944058/Documents/Sheep/R/Metacarpal/Adult/50K/MetacarpalLength_Adult_50K_Conditional_H2.blue.discrete",header=TRUE)
Assoc$NAME <- c("Sex")
SNPs_50K <- read.table("C:/Users/s1944058/Documents/Sheep/R/Metacarpal/Adult/50K/SNPs_50K.txt",header=F)
...
QAssoc <- read.table("C:/Users/s1944058/Documents/Sheep/R/Metacarpal/Adult/50K/MetacarpalLength_Adult_50K_Conditional_H2.blue.quantitative",header=TRUE)
QAssoc$NAME <- c("Age at death",SNPs_50K[,3])
FixedEffects_50K <- rbind(Assoc,QAssoc)

Random <- read.csv("C:/Users/s1944058/Documents/Sheep/R/Metacarpal/Adult/50K/MetacarpalLength_Adult_50K_Conditional_H2.reml")
...
>module load igmm/apps/plink/1.90b4  
>  
>mpirun -np 8 dissect.mpich  \-\-reml \-\-bfile ../InputData/HD_QC \-\-pheno MetacarpalPhenotypes.txt \-\-pheno-col 1 \-\-blue \-\-covar Assoc.txt \-\-qcovar QAssoc.txt \-\-random-effects MetacarpalRandom.txt \-\-random-effects-cols 1 2 \-\-out HD/MetacarpalLength_Adult_HD_Conditional_H2  
>  
>if [[ -f HD/MetacarpalLength_Adult_HD_Conditional_H2.badsnps ]]  
>then    
>plink \-\-bfile ../InputData/HD_QC \-\-sheep \-\-exclude HD/MetacarpalLength_Adult_HD_Conditional_H2.badsnps \-\-make-bed \-\-out HD/MetacarpalLength_Adult_HD_Conditional_H2  
>
>mpirun -np 8 dissect.mpich  \-\-reml \-\-bfile HD/MetacarpalLength_Adult_HD_Conditional_H2 \-\-pheno MetacarpalPhenotypes.txt \-\-pheno-col 1 \-\-blue \-\-covar Assoc.txt \-\-qcovar QAssoc.txt \-\-random-effects MetacarpalRandom.txt \-\-random-effects-cols 1 2 \-\-out HD/MetacarpalLength_Adult_HD_Conditional_H2  
>fi 
 

```{r,include=FALSE}
Assoc <- read.table("C:/Users/s1944058/Documents/Sheep/R/Metacarpal/Adult/HD/MetacarpalLength_Adult_HD_Conditional_H2.blue.discrete",header=TRUE)
Assoc$NAME <- c("Sex")
SNPs_HD <- read.table("C:/Users/s1944058/Documents/Sheep/R/Metacarpal/Adult/HD/SNPs_HD.txt",header=F)
...
QAssoc <- read.table("C:/Users/s1944058/Documents/Sheep/R/Metacarpal/Adult/HD/MetacarpalLength_Adult_HD_Conditional_H2.blue.quantitative",header=TRUE)
QAssoc$NAME <- c("Age at death",SNPs_HD[,3])
FixedEffects_HD <- rbind(Assoc,QAssoc)

Random <- read.csv("C:/Users/s1944058/Documents/Sheep/R/Metacarpal/Adult/HD/MetacarpalLength_Adult_HD_Conditional_H2.reml")
...
>fi  
>  
>mpirun -np 8 dissect.mpich  \-\-gwas \-\-bfile-grm-list 50K/GWAS_GRM\$\{i}.txt \-\-pheno MetacarpalPhenotypes.txt \-\-covar Assoc.txt \-\-qcovar QAssoc.txt \-\-random-effects MetacarpalRandom.txt \-\-random-effects-cols 1,2  \-\-out 50K/MetacarpalLength_Adult_50K_GWAS_Conditional_Chr\$\{i}  
>  
>if [[ -f 50K/MetacarpalLength_Adult_50K_GWAS_Conditional_Chr\$\{i}.badsnps ]]  
>then  
>plink \-\-bfile 50K/Chr\$\{i} \-\-sheep \-\-exclude 50K/MetacarpalLength_Adult_50K_GWAS_Conditional_Chr\$\{i}.badsnps \-\-make-bed \-\-out 50K/Chr\$\{i}_2  
>  
...
```{r,fig.width=14}
files = list.files(pattern="MetacarpalLength_Adult_50K_GWAS_Conditional_Chr",recursive=TRUE)
...
>fi  
>  
>mpirun -np 8 dissect.mpich  \-\-gwas \-\-bfile-grm-list HD/GWAS_GRM\$\{i}.txt \-\-pheno MetacarpalPhenotypes.txt \-\-covar Assoc.txt \-\-qcovar QAssoc.txt \-\-random-effects MetacarpalRandom.txt \-\-random-effects-cols 1,2  \-\-out HD/MetacarpalLength_Adult_HD_GWAS_Conditional_Chr\$\{i}  
>  
>if [[ -f HD/MetacarpalLength_Adult_HD_GWAS_Conditional_Chr\$\{i}.badsnps ]]  
>then  
>plink \-\-bfile HD/Chr\$\{i} \-\-sheep \-\-exclude HD/MetacarpalLength_Adult_HD_GWAS_Conditional_Chr\$\{i}.badsnps \-\-make-bed \-\-out HD/Chr\$\{i}_2  
>
...
```{r,fig.width=14}
files = list.files(pattern="MetacarpalLength_Adult_HD_GWAS_Conditional_Chr",recursive=TRUE)
