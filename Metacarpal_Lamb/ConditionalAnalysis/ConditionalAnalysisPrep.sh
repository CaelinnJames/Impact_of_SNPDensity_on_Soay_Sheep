...
plink --bfile ../../InputData/Plates_1to87_QC3 --sheep --extract SNPs_50K.txt --keep MetacarpalLength_LambPhenotypes.txt --recodeA --out LambHLSNP 
...
plink --bfile ../../InputData/HD_QC --sheep --extract SNPs_HD.txt --keep MetacarpalLength_LambPhenotypes.txt --recodeA --out LambHLSNP
cut -d ' ' -f 3-6 --complement LambHLSNP.raw > LambHLSNP.txt
sed '1d' LambHLSNP.txt > LambHLSNP2.txt
